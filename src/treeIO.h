...
char *pllTreeToNewick(char *treestr, tree *tr, nodeptr p, boolean printBranchLengths, boolean printNames,
        boolean printInternalNodeLabels, boolean printLikelihood, boolean rellTree,
        int perGene, boolean branchLabelSupport, boolean printSHSupport);
