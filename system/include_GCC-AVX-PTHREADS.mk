...
OPT_FLAGS     =-mavx -msse3 -O2 -fomit-frame-pointer -funroll-loops 
DEFINES      +=-D_USE_PTHREADS -D__SIM_SSE3 -D_OPTIMIZED_FUNCTIONS -D_GNU_SOURCE -D__AVX
SPECIAL_SRC  += avxLikelihood.c
SPECIAL_FLAGS =-mavx
